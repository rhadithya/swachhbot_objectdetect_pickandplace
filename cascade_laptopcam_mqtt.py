...
while(1):
    ...
    ##############################################
    objects1 =cascade1.detectMultiScale(gray, 1.3,5) #(1.1,5)
    for (x,y,w,h) in objects1:
        ...
        midX=x+w/2
        midY=y+h/2
        cv2.putText(img1,'matchbox',(20,20), font, 0.5, (255,255,255), 1, cv2.CV_AA)
        ...
        error_string="object1 "+str(errorX)+" "+str(errorY)
        mqttc.publish(topic='errorvals',payload=error_string, qos=0)
        print(error_string)
        

    objects2 =cascade2.detectMultiScale(gray, 1.3,10)
    for (a,b,c,d) in objects2:
        ...
        midX=a+c/2
        midY=b+d/2
        cv2.putText(img1,'rpi-box',(20,20), font, 0.5, (255,255,255), 1, cv2.CV_AA)
        cv2.putText(img1,'x:'+ str(midX),(20,40), font, 0.5, (255,255,255), 1, cv2.CV_AA)
        cv2.putText(img1,'y:'+ str(midY),(20,60), font, 0.5, (255,255,255), 1, cv2.CV_AA)
